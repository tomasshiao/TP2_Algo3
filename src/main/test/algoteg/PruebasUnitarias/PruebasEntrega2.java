...
//
//
//        TurnoColocacion turnoColocacion = new TurnoColocacion(tablero, j1);
//        TurnoColocacion turnoColocacion2 = new TurnoColocacion(tablero, j2);
//
//        turnoColocacion.setEjercitosDisponiblesParaColocar();
//
//        turnoColocacion2.setEjercitosDisponiblesParaColocar();
//
//        turnoColocacion.colocarEjercitos(1,p1);
//        turnoColocacion2.colocarEjercitos(1,p2);
//
...
//        TurnoColocacion turnoColocacion = new TurnoColocacion(tablero, j1);
//        TurnoColocacion turnoColocacion2 = new TurnoColocacion(tablero, j2);
//        TurnoColocacion turnoColocacion3 = new TurnoColocacion(tablero, j3);
//
//        turnoColocacion.setEjercitosDisponiblesParaColocar();
//        turnoColocacion2.setEjercitosDisponiblesParaColocar();
//        turnoColocacion3.setEjercitosDisponiblesParaColocar();
//
//        turnoColocacion.colocarEjercitos(1,p1);
//        turnoColocacion2.colocarEjercitos(1,p3);
//        turnoColocacion3.colocarEjercitos(1,p5);
//
//
//
//        assertEquals(2, j1.getCantidadPaisesConquistados());
...
//        }
//
//        TurnoAtaque turnoAtaque = new TurnoAtaque(tableroMock, atacante);
//
//        //Map<String, String> outMap = new HashMap<>();
//
//        turnoAtaque.atacar(paisAtacante,paisASerConquistadoPrimero,1);
//        turnoAtaque.atacar(paisAtacante,paisASerConquistadoDespues,1);
